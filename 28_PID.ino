...
// PID parameters
#define _KP 2.8   // proportional gain
#define _KD 280.0   // derivative gain
#define _KI 0.00002   // integral gain
...
float volt_to_distance(int x)
{
  ...
  return 1004 + -5.11*x + (9.45E-03)*x*x + -(6.14E-06)*x*x*x;
}
